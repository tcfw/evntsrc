...
func (m *AcknowledgeResponse) GetEventID() string {
	if m != nil {
		return m.EventID
	}
	return ""
...
func (*StoreRequest) Descriptor() ([]byte, []int) { return fileDescriptorStorer, []int{8} }
...
func (*StoreRequest) XXX_MessageName() string {
	return "evntsrc.storer.StoreRequest"
}
...
func (*StoreResponse) Descriptor() ([]byte, []int) { return fileDescriptorStorer, []int{9} }

func (*StoreResponse) XXX_MessageName() string {
	return "evntsrc.storer.StoreResponse"
}
...
func (*DeleteRequest) Descriptor() ([]byte, []int) { return fileDescriptorStorer, []int{10} }
...
func (*DeleteRequest) XXX_MessageName() string {
	return "evntsrc.storer.DeleteRequest"
}
...
func (*DeleteResponse) Descriptor() ([]byte, []int) { return fileDescriptorStorer, []int{11} }

func (*DeleteResponse) XXX_MessageName() string {
	return "evntsrc.storer.DeleteResponse"
}
func init() {
	...
	proto.RegisterType((*StoreRequest)(nil), "evntsrc.storer.StoreRequest")
	proto.RegisterType((*StoreResponse)(nil), "evntsrc.storer.StoreResponse")
	proto.RegisterType((*DeleteRequest)(nil), "evntsrc.storer.DeleteRequest")
	proto.RegisterType((*DeleteResponse)(nil), "evntsrc.storer.DeleteResponse")
}
...
func (c *storerServiceClient) Store(ctx context.Context, in *StoreRequest, opts ...grpc.CallOption) (*StoreResponse, error) {
	out := new(StoreResponse)
	err := grpc.Invoke(ctx, "/evntsrc.storer.StorerService/Store", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *storerServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	out := new(DeleteResponse)
	err := grpc.Invoke(ctx, "/evntsrc.storer.StorerService/Delete", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StorerService_Store_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorerServiceServer).Store(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evntsrc.storer.StorerService/Store",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorerServiceServer).Store(ctx, req.(*StoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StorerService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorerServiceServer).Delete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evntsrc.storer.StorerService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorerServiceServer).Delete(ctx, req.(*DeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _StorerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Store",
			Handler:    _StorerService_Store_Handler,
		},
		{
			MethodName: "Delete",
			Handler:    _StorerService_Delete_Handler,
		},
	},
...
func (m *StoreRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Event != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintStorer(dAtA, i, uint64(m.Event.Size()))
...
var fileDescriptorStorer = []byte{
	...
	,
}
