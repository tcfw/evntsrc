...
goog.exportSymbol('proto.evntsrc.users.User.Status', null, global);
goog.exportSymbol('proto.evntsrc.users.UserList', null, global);
goog.exportSymbol('proto.evntsrc.users.UserRequest', null, global);
goog.exportSymbol('proto.evntsrc.users.UserRequest.Status', null, global);
goog.exportSymbol('proto.evntsrc.users.UserUpdateRequest', null, global);
goog.exportSymbol('proto.evntsrc.users.ValidateRequest', null, global);
...
proto.evntsrc.users.User.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = /** @type {!proto.evntsrc.users.User.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @enum {number}
 */
proto.evntsrc.users.User.Status = {
  PENDING: 0,
  ACTIVE: 1,
  DELETED: 2
};
 ...
 * @return {!proto.evntsrc.users.User.Status}
 */
proto.evntsrc.users.User.prototype.getStatus = function() {
  return /** @type {!proto.evntsrc.users.User.Status} */ (jspb.Message.getFieldWithDefault(this, 10, 0));
};


/** @param {!proto.evntsrc.users.User.Status} value */
proto.evntsrc.users.User.prototype.setStatus = function(value) {
...
proto.evntsrc.users.UserRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.evntsrc.users.UserRequest.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @enum {number}
 */
proto.evntsrc.users.UserRequest.Status = {
  ACTIVE: 0,
  PENDING: 1,
  DELETED: 2,
  ANY: 99
 ...
 * @return {!proto.evntsrc.users.UserRequest.Status}
 */
proto.evntsrc.users.UserRequest.prototype.getStatus = function() {
  return /** @type {!proto.evntsrc.users.UserRequest.Status} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {!proto.evntsrc.users.UserRequest.Status} value */
proto.evntsrc.users.UserRequest.prototype.setStatus = function(value) {
 ...
 * @constructor
 */
proto.evntsrc.users.ValidateRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.evntsrc.users.ValidateRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.evntsrc.users.ValidateRequest.displayName = 'proto.evntsrc.users.ValidateRequest';
}
 ...
 * @return {!Object}
 */
proto.evntsrc.users.ValidateRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.evntsrc.users.ValidateRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.evntsrc.users.ValidateRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evntsrc.users.ValidateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    email: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.evntsrc.users.ValidateRequest}
 */
proto.evntsrc.users.ValidateRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.evntsrc.users.ValidateRequest;
  return proto.evntsrc.users.ValidateRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.evntsrc.users.ValidateRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.evntsrc.users.ValidateRequest}
 */
proto.evntsrc.users.ValidateRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.evntsrc.users.ValidateRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.evntsrc.users.ValidateRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.evntsrc.users.ValidateRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evntsrc.users.ValidateRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEmail();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.evntsrc.users.ValidateRequest.prototype.getEmail = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.evntsrc.users.ValidateRequest.prototype.setEmail = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.evntsrc.users.ValidateRequest.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.evntsrc.users.ValidateRequest.prototype.setToken = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
