...
goog.exportSymbol('proto.evntsrc.emails.Recipient', null, global);
 ...
 * @constructor
 */
proto.evntsrc.emails.Recipient = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.evntsrc.emails.Recipient, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.evntsrc.emails.Recipient.displayName = 'proto.evntsrc.emails.Recipient';
}
 ...
 * @return {!Object}
 */
proto.evntsrc.emails.Recipient.prototype.toObject = function(opt_includeInstance) {
  return proto.evntsrc.emails.Recipient.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.evntsrc.emails.Recipient} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evntsrc.emails.Recipient.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.evntsrc.emails.Recipient}
 */
proto.evntsrc.emails.Recipient.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.evntsrc.emails.Recipient;
  return proto.evntsrc.emails.Recipient.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.evntsrc.emails.Recipient} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.evntsrc.emails.Recipient}
 */
proto.evntsrc.emails.Recipient.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.evntsrc.emails.Recipient.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.evntsrc.emails.Recipient.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.evntsrc.emails.Recipient} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.evntsrc.emails.Recipient.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getEmail();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.evntsrc.emails.Recipient.prototype.getEmail = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.evntsrc.emails.Recipient.prototype.setEmail = function(value) {
 ...
 * @return {string}
 */
proto.evntsrc.emails.Recipient.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.evntsrc.emails.Recipient.prototype.setName = function(value) {
...
proto.evntsrc.emails.Email.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.evntsrc.emails.Recipient.toObject, includeInstance),
...
proto.evntsrc.emails.Email.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.evntsrc.emails.Recipient;
      reader.readMessage(value,proto.evntsrc.emails.Recipient.deserializeBinaryFromReader);
      msg.addTo(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
...
proto.evntsrc.emails.Email.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.evntsrc.emails.Recipient.serializeBinaryToWriter
    );
  }
 ...
 * @return {!Array<!proto.evntsrc.emails.Recipient>}
 */
proto.evntsrc.emails.Email.prototype.getToList = function() {
  return /** @type{!Array<!proto.evntsrc.emails.Recipient>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.evntsrc.emails.Recipient, 2));
};


/** @param {!Array<!proto.evntsrc.emails.Recipient>} value */
...
/**
 * @param {!proto.evntsrc.emails.Recipient=} opt_value
 * @param {number=} opt_index
 * @return {!proto.evntsrc.emails.Recipient}
 */
proto.evntsrc.emails.Email.prototype.addTo = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.evntsrc.emails.Recipient, opt_index);
};
