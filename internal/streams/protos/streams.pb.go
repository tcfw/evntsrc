...
func (m *Stream) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Metadata) > 0 {
		for k, _ := range m.Metadata {
			...
			byteSize := 0
			if len(v) > 0 {
				byteSize = 1 + len(v) + sovStreams(uint64(len(v)))
			}
			mapSize := 1 + len(k) + sovStreams(uint64(len(k))) + byteSize
			i = encodeVarintStreams(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
...
func (m *Stream) Size() (n int) {
	...
	if len(m.Metadata) > 0 {
		for k, v := range m.Metadata {
			...
			l = 0
			if len(v) > 0 {
				l = 1 + len(v) + sovStreams(uint64(len(v)))
			}
			mapEntrySize := 1 + len(k) + sovStreams(uint64(len(k))) + l
...
var fileDescriptorStreams = []byte{
	...
	,
}
