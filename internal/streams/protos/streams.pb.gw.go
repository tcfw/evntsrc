...
var (
	filter_StreamsService_Delete_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
func request_StreamsService_Delete_0(ctx context.Context, marshaler runtime.Marshaler, client StreamsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_StreamsService_Delete_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterStreamsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client StreamsServiceClient) error {
	...
	mux.Handle("POST", pattern_StreamsService_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req)
...
var (
	pattern_StreamsService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "stream"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_StreamsService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "streams"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_StreamsService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "stream", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_StreamsService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "stream", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_StreamsService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "stream", "id"}, "", runtime.AssumeColonVerbOpt(true)))
)
